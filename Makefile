...
debug:
	@echo "target a"
	@echo "Cflags: $(CFLAGS)"
	@echo "Basecflags: $(BASE_CFLAGS)"
	@echo $(MAKE) targets B=$(BD) CFLAGS="$(CFLAGS) $(BASE_CFLAGS) $(DEPEND_CFLAGS)" \
...
release:
	...
	@echo "Cflags: $(CFLAGS)"
	@echo "Basecflags: $(BASE_CFLAGS)"
	@echo $(MAKE) targets B=$(BR) CFLAGS="$(CFLAGS) $(BASE_CFLAGS) $(DEPEND_CFLAGS)" \
...
Q3GOBJ_ = \
  ...
  $(B)/$(BASEGAME)/game/g_svcmds_ext.o \
...
Q3UIOBJ_ = \
  ...
  $(B)/$(BASEGAME)/ui/ui_votemenu_kick.o \
  $(B)/$(BASEGAME)/ui/ui_votemenu_map.o \
  $(B)/$(BASEGAME)/ui/ui_votemenu_custom.o \
  \
  $(B)/$(BASEGAME)/qcommon/q_math.o \
  $(B)/$(BASEGAME)/qcommon/q_shared.o
